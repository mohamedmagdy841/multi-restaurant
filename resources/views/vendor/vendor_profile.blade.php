            ...
            <div class="row">
                <div class="col-xl-9 col-lg-8">
                                    ...
                                    <div class="d-flex align-items-start mt-3 mt-sm-0">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-xl me-3">
                                                <img src="{{ (!empty($profileData->photo)) ? url('upload/vendor_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="" class="img-fluid rounded-circle d-block">
                                            </div>
                                        </div>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('vendor.profile_store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <img id="showImage" src="{{ (!empty($profileData->cover_photo)) ? url('upload/vendor_images/'.$profileData->cover_photo) : url('upload/no_image.jpg') }}" alt="" class="p-1 bg-primary" width="210" height="100">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3 mt-lg-0">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/vendor_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="" class="rounded-circle p-1 bg-primary" width="110">
                                        </div>
                                        <div class="mt-4">
