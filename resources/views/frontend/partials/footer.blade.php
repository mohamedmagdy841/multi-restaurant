<section class="section pt-5 pb-5 text-center bg-white">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="m-0">Operate food store or restaurants? <a href="{{ route('vendor.login') }}">Work With Us</a></h5>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-12 col-sm-12">
                ...
                <p><a class="text-info" href="{{ route('register') }}">Register now</a> to get updates on Offers and Coupons</p>
                <div class="app">
                    <p class="mb-2">DOWNLOAD APP</p>
                    <a href="#">
                        <img class="{{ asset('frontend') }}/img-fluid" src="{{ asset('frontend') }}/img/google.png">
                    </a>
                    <a href="#">
                        <img class="{{ asset('frontend') }}/img-fluid" src="{{ asset('frontend') }}/img/apple.png">
                    </a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="search-links">
                    <a href="#">Egypt</a> |  <a href="#">Brasil</a> | <a href="#">Canada</a> |  <a href="#">Chile</a>  |  <a href="#">Czech Republic</a> |  <a href="#">India</a>  |  <a href="#">Indonesia</a> |  <a href="#">Ireland</a> |  <a href="#">New Zealand</a> | <a href="#">United Kingdom</a> |  <a href="#">Turkey</a>  |  <a href="#">Philippines</a> |  <a href="#">Sri Lanka</a>  |  <a href="#">Australia</a> |  <a href="#">Brasil</a> | <a href="#">Canada</a> |  <a href="#">Chile</a>  |  <a href="#">Czech Republic</a> |  <a href="#">India</a>  |  <a href="#">Indonesia</a> |  <a href="#">Ireland</a> |  <a href="#">New Zealand</a> | <a href="#">United Kingdom</a> |  <a href="#">Turkey</a>  |  <a href="#">Philippines</a> |  <a href="#">Sri Lanka</a><a href="#">Australia</a> |  <a href="#">Brasil</a>
                </div>
