...
@section('dashboard')
    ...
    <section class="restaurant-detailed-banner">
        <div class="text-center">
            <img class="img-fluid cover" src="{{ asset('upload/vendor_images/' . $vendor->cover_photo ) }}">
        </div>
                ...
                <div class="row d-flex align-items-end">
                    <div class="col-md-8">
                        <div class="restaurant-detailed-header-left">
                            <img class="img-fluid mr-3 float-left" alt="osahan" src="{{ asset('upload/vendor_images/' . $vendor->photo ) }}">
    ...
    <section class="offer-dedicated-body pt-2 pb-2 mt-4 mb-4">
        <div class="container">
            <div class="row">
                    ...
                    <div class="offer-dedicated-body-left">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-order-online" role="tabpanel" aria-labelledby="pills-order-online-tab">
                                ...
                                @php
                                    $populars = App\Models\Product::where('status',1)->where('vendor_id',$vendor->id)->where('most_popular',1)->orderBy('id','desc')->limit(5)->get();
                                @endphp
                                ...
                                @php
                                    $bestsellers = App\Models\Product::where('status',1)->where('vendor_id',$vendor->id)->where('best_seller',1)->orderBy('id','desc')->limit(3)->get();
                                @endphp
                            ...
                            <div class="tab-pane fade" id="pills-restaurant-info" role="tabpanel" aria-labelledby="pills-restaurant-info-tab">
                                <div id="restaurant-info" class="bg-white rounded shadow-sm p-4 mb-4">
                                    ...
                                    <p class="mb-3">{{ $vendor->address }}

                                    </p>
                                    <p class="mb-2 text-black"><i class="icofont-phone-circle text-primary mr-2"></i> {{ $vendor->phone }}</p>
                                    <p class="mb-2 text-black"><i class="icofont-email text-primary mr-2"></i> {{ $vendor->email }}</p>
                                    <p class="mb-2 text-black"><i class="icofont-clock-time text-primary mr-2"></i> {{ $vendor->shop_info }}
                                        <span class="badge badge-success"> OPEN NOW </span>
                                    </p>
                                    <hr class="clearfix">
                                    <p class="text-black mb-0">You can also check the 3D view by using our map clicking here &nbsp;&nbsp;&nbsp; <a class="text-info font-weight-bold" href="#">Venue Map</a></p>
                                    <hr class="clearfix">
                         ...
                         <a href="#"><i class="icofont-ui-rating icofont-2x"></i></a>
                                ...
                                <div class="bg-white rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews">
                                    ...
                                    @php
                                        $reviews = App\Models\Review::where('vendor_id',$vendor->id)->where('status',1)->latest()->limit(5)->get();
                                    @endphp
                                ...
                                <div class="bg-white rounded shadow-sm p-4 mb-5 rating-review-select-page">
                                    @guest
                                        <p><b>To Review Restaurant. You need to login first <a href="{{ route('login') }}"> Login Here </a> </b></p>
                                    @else
                ...
                @php
                    use Carbon\Carbon;
                    $coupon = App\Models\Coupon::where('vendor_id',$vendor->id)->where('validity','>=', Carbon::now()->format('Y-m-d'))->latest()->first();
                @endphp
