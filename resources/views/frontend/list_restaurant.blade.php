        ...
        <div class="container">
            <div class="row d-none-m">
                <div class="col-md-12">
                    ...
                    <h4 class="font-weight-bold mt-0 mb-3">OFFERS <small class="h6 mb-0 ml-2">3 restaurants
                        </small>
                    </h4>
                </div>
            </div>
                        ...
                        <div class="col-md-4 col-sm-6 mb-4 pb-2">
                            <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                <div class="list-card-image">
                                    ...
                                    <div class="favourite-heart text-danger position-absolute"><a href="{{ route('res.details',$product->vendor_id) }}"><i class="icofont-heart"></i></a></div>
                                    <div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
                                    <a href="{{ route('res.details',$product->vendor_id) }}">
                                        <img src="{{ asset($product->image) }}" class="img-fluid item-img">
                                    </a>
                                </div>
                                <div class="p-3 position-relative">
                                    <div class="list-card-body">
                                        <h6 class="mb-1"><a href="{{ route('res.details',$product->vendor_id) }}" class="text-black"> {{ $product->name}}</a></h6>
