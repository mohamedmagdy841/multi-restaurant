...
@section('dashboard')
                                        ...
                                        <div class="gold-members p-4">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="text-black">{{ Auth::user()->address }}
                                                    </p>
                                        ...
                                        <div class="gold-members p-4">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p>56 El-Montazah Rd., Heliopolis, Cairo, Egypt
                                                    </p>
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe('pk_test_51QIF0GCvn5Ags20Z4o3CxccOYqeX6NxKcJCwWQX7JiYaPPO31gC0vqfEv0PL9lWPPekGmUaDRafBSpQ2M2l2sy7v00DqBck7TI');
